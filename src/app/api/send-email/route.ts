...
export async function POST(req: Request) {
  try {
    ...
    const { teamId, teamName, leadName, leadEmail, leadIdNumber, department, members = [] } = body;
        ...
        <div class="container">
          ...
          <div class="content">
            ...
            <div class="details-card">
              <div class="details-row"><span class="details-label">Assigned Team ID:</span><span class="details-value" style="color: #4f46e5;">${teamId}</span></div>
    ...
    await transporter.sendMail({
      ...
      to: leadEmail,
      subject: `[SIH 2026] Team Registration Confirmed — ${teamId} (${teamName})`,
      html: htmlContent,
      attachments: attachments
    });

    return NextResponse.json({ success: true, message: 'Confirmation email sent successfully via Nodemailer.' });
  } catch (error) {
